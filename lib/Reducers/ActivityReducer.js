...
var success = function success(state, action) {
  console.log('ACTIVITY SUCCESS REDUCER', action);
  ...
  return state.merge({
    attempting: false,
    errorCode: null,
    entities: state.entities.merge(action.payload.entities.activity),
...
var ACTION_HANDLERS = (_ACTION_HANDLERS = {}, (0, _defineProperty3.default)(_ACTION_HANDLERS, _Types2.default.GET_ACTIVITY_REQUEST, attempt), (0, _defineProperty3.default)(_ACTION_HANDLERS, _Types2.default.GET_ACTIVITY_SUCCESS, success), (0, _defineProperty3.default)(_ACTION_HANDLERS, _Types2.default.GET_ACTIVITY_FAILURE, failure), _ACTION_HANDLERS);
