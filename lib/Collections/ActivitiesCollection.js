        ...
        return _react2.default.createElement(
          ...
          activities.items.map(function (item, id) {
            return _react2.default.createElement(
              ...
              { key: id },
              _react2.default.createElement(_Activity2.default, { activity: item, user_id: user_id, meta: true })
            );
          })
        );
      }
      ...
      return _react2.default.createElement(
        ...
        activities.items.map(function (item, id) {
          return _react2.default.createElement(
            _reactFoundation.Column,
            { key: id },
            _react2.default.createElement(_Activity2.default, { activity: item, user_id: user_id, meta: false })
          );
        })
      );
    }
